...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data"> {{-- enctype="multipart/form-data" ini agar form bisa menangani inputan file --}}
          @method('put')
            @csrf
            {{-- title --}}
            <div class="mb-3">
    ...
    <script>
        ...
        // menampilkan gambar ketika input gambar
